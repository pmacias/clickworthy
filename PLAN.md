...
**4c. Confirmatory validation (`06_results_summary.ipynb`, required regardless of 4a/4b).** Preregister (in the notebook, before touching the data) the 2–3 headline claims from Stages 1–3; run them once against the confirmatory sample; report agreement or disagreement honestly. This is the capstone and the thing that makes the README credible.
